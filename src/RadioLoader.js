...
const TIMBL_BOOT_STEPS = [
  "Tim Berners-Lee System v1.0 initialized",
  "Checking system resources...",
  "Mounting Solid filesystem...",
  "Authenticating secure session...",
  "Initializing user interface...",
...
const RadioLoader = () => {
  ...
  const bootSteps = isNeXTTheme ? NEXT_BOOT_STEPS : TIMBL_BOOT_STEPS;
      ...
      <div className={`${classes.window} mx-auto max-w-md w-full`}>
        ...
        <div className={classes.titleBar}>
          <div className={classes.titleText}>
            {isNeXTTheme ? "NeXT-FM Boot Console" : "TBL-FM Boot Console"}
          </div>
        ...
        <div className={`${isNeXTTheme ? "bg-next-dark border-t border-next-border" : "bg-white"}`}>
          ...
          <div className={`flex items-center justify-center p-3 ${
            ...
            <img 
              src={logoToUse} 
              alt={isNeXTTheme ? "NeXT Logo" : "TimBL Logo"} 
              className="h-14 mr-3"
            />
            <div>
              <h2 className={`font-bold text-sm ${
                ...
                {isNeXTTheme ? "NeXT-FM System" : "TBL-FM System"}
              </h2>
              <p className={`text-xs ${
