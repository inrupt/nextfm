      ...
      <div className={classes.container}>
        <div className={classes.window}>
          ...
          <div className={classes.titleBar}>
            <div className={classes.titleText}>{isNeXTTheme ? "Solid File Manager" : "Tim Berners-Lee's File Manager"}</div>
          ...
          <footer className={classes.footer}>
            <div className="text-xs">
              <span className="mr-1">•</span> {currentTheme === THEMES.NEXT ? 'NeXT-FM' : 'TBL-FM'} v1.0
            </div>
            <div className="text-xs">
              Solid Protocol
            </div>
